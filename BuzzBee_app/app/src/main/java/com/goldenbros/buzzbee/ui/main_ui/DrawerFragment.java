...
import com.goldenbros.buzzbee.adapter.NavigationDrawerAdapter;
...
public class DrawerFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View layout = inflater.inflate(R.layout.main_navigation_drawer_fragment, container, false);
        ...
        userProfileImageView = (ImageView) layout.findViewById(R.id.user_image);
        ...
        if(queryUser.getPhotoName() != null) {
            Log.d("~~Drawer getImage", queryUser.getPhotoName());
